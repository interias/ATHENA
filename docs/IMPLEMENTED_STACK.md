...
| SQLite | `3.40.1` in Python 3.13.7 | `sqlite3.sqlite_version` wurde im finalen API-Image abgefragt. Eine Datei liegt im Volume `learning_data`; Foreign Keys und Busy Timeout werden pro API-Verbindung aktiviert. |
